...
class V1DownwardAPIVolumeSource(object):
    ...
    """
    def __init__(self, items=None, defaultMode=None):
        """
    ...
    def defaultMode(self):
        """
        Gets the defaultMode of this V1DownwardAPIVolumeSource.
        Optional: mode bits to use on created files by default. Must be a value between 0 and 0777. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.

        :return: The defaultMode of this V1DownwardAPIVolumeSource.
        :rtype: int
        """
    ...
    def defaultMode(self, defaultMode):
        """
        Sets the defaultMode of this V1DownwardAPIVolumeSource.
        Optional: mode bits to use on created files by default. Must be a value between 0 and 0777. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.

        :param defaultMode: The defaultMode of this V1DownwardAPIVolumeSource.
        :type: int
        """
