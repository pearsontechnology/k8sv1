...
class V1ReplicationControllerCondition(object):
    ...
    def lastTransitionTime(self):
        """
        Gets the lastTransitionTime of this V1ReplicationControllerCondition.
        The last time the condition transitioned from one status to another.

        :return: The lastTransitionTime of this V1ReplicationControllerCondition.
        :rtype: datetime
        """
    ...
    def lastTransitionTime(self, lastTransitionTime):
        """
        Sets the lastTransitionTime of this V1ReplicationControllerCondition.
        The last time the condition transitioned from one status to another.

        :param lastTransitionTime: The lastTransitionTime of this V1ReplicationControllerCondition.
        :type: datetime
        """
