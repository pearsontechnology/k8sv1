...
class V1PersistentVolumeSpec(object):
    ...
    """
    def __init__(self, capacity=None, gcePersistentDisk=None, awsElasticBlockStore=None, hostPath=None, glusterfs=None, nfs=None, rbd=None, iscsi=None, cinder=None, cephfs=None, fc=None, flocker=None, flexVolume=None, azureFile=None, vsphereVolume=None, quobyte=None, azureDisk=None, accessModes=None, claimRef=None, persistentVolumeReclaimPolicy=None):
        """
    ...
    def azureDisk(self):
        """
        Gets the azureDisk of this V1PersistentVolumeSpec.
        AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.

        :return: The azureDisk of this V1PersistentVolumeSpec.
    ...
    def azureDisk(self, azureDisk):
        """
        Sets the azureDisk of this V1PersistentVolumeSpec.
        AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.

        :param azureDisk: The azureDisk of this V1PersistentVolumeSpec.
