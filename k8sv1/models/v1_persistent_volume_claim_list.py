...
class V1PersistentVolumeClaimList(object):
    ...
    def apiVersion(self):
        """
        Gets the apiVersion of this V1PersistentVolumeClaimList.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#resources

        :return: The apiVersion of this V1PersistentVolumeClaimList.
        :rtype: str
        """
    ...
    def apiVersion(self, apiVersion):
        """
        Sets the apiVersion of this V1PersistentVolumeClaimList.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#resources

        :param apiVersion: The apiVersion of this V1PersistentVolumeClaimList.
        :type: str
        """
