...
class V1ReplicationControllerStatus(object):
    ...
    def fullyLabeledReplicas(self):
        """
        Gets the fullyLabeledReplicas of this V1ReplicationControllerStatus.
        The number of pods that have labels matching the labels of the pod template of the replication controller.

        :return: The fullyLabeledReplicas of this V1ReplicationControllerStatus.
        :rtype: int
        """
    ...
    def fullyLabeledReplicas(self, fullyLabeledReplicas):
        """
        Sets the fullyLabeledReplicas of this V1ReplicationControllerStatus.
        The number of pods that have labels matching the labels of the pod template of the replication controller.

        :param fullyLabeledReplicas: The fullyLabeledReplicas of this V1ReplicationControllerStatus.
        :type: int
        """
    ...
    def readyReplicas(self):
        """
        Gets the readyReplicas of this V1ReplicationControllerStatus.
        The number of ready replicas for this replication controller.

        :return: The readyReplicas of this V1ReplicationControllerStatus.
        :rtype: int
        """
    ...
    def readyReplicas(self, readyReplicas):
        """
        Sets the readyReplicas of this V1ReplicationControllerStatus.
        The number of ready replicas for this replication controller.

        :param readyReplicas: The readyReplicas of this V1ReplicationControllerStatus.
        :type: int
        """
    ...
    def availableReplicas(self):
        """
        Gets the availableReplicas of this V1ReplicationControllerStatus.
        The number of available replicas (ready for at least minReadySeconds) for this replication controller.

        :return: The availableReplicas of this V1ReplicationControllerStatus.
        :rtype: int
        """
    ...
    def availableReplicas(self, availableReplicas):
        """
        Sets the availableReplicas of this V1ReplicationControllerStatus.
        The number of available replicas (ready for at least minReadySeconds) for this replication controller.

        :param availableReplicas: The availableReplicas of this V1ReplicationControllerStatus.
        :type: int
        """
    ...
    def observedGeneration(self):
        """
        Gets the observedGeneration of this V1ReplicationControllerStatus.
        ObservedGeneration reflects the generation of the most recently observed replication controller.

        :return: The observedGeneration of this V1ReplicationControllerStatus.
        :rtype: int
        """
    ...
    def observedGeneration(self, observedGeneration):
        """
        Sets the observedGeneration of this V1ReplicationControllerStatus.
        ObservedGeneration reflects the generation of the most recently observed replication controller.

        :param observedGeneration: The observedGeneration of this V1ReplicationControllerStatus.
        :type: int
        """
