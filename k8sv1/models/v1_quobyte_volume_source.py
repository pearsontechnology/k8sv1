...
class V1QuobyteVolumeSource(object):
    ...
    """
    def __init__(self, registry=None, volume=None, readOnly=None, user=None, group=None):
        """
    ...
    def readOnly(self):
        """
        Gets the readOnly of this V1QuobyteVolumeSource.
        ReadOnly here will force the Quobyte volume to be mounted with read-only permissions. Defaults to false.

        :return: The readOnly of this V1QuobyteVolumeSource.
        :rtype: bool
        """
    ...
    def readOnly(self, readOnly):
        """
        Sets the readOnly of this V1QuobyteVolumeSource.
        ReadOnly here will force the Quobyte volume to be mounted with read-only permissions. Defaults to false.

        :param readOnly: The readOnly of this V1QuobyteVolumeSource.
        :type: bool
        """
