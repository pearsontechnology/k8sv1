...
**items** | [**list[V1ReplicationController]**](V1ReplicationController.md) | List of replication controllers. More info: http://releases.k8s.io/HEAD/docs/user-guide/replication-controller.md | 
