...
from k8sv1.models.v1_aws_elastic_block_store_volume_source import V1AWSElasticBlockStoreVolumeSource
...
class TestV1AWSElasticBlockStoreVolumeSource(unittest.TestCase):
    ...
    def testV1AWSElasticBlockStoreVolumeSource(self):
        ...
        """
        model = k8sv1.models.v1_aws_elastic_block_store_volume_source.V1AWSElasticBlockStoreVolumeSource()
