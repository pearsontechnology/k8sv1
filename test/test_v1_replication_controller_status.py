...
from k8sv1.models.v1_replication_controller_status import V1ReplicationControllerStatus
...
class TestV1ReplicationControllerStatus(unittest.TestCase):
    ...
    def testV1ReplicationControllerStatus(self):
        ...
        """
        model = k8sv1.models.v1_replication_controller_status.V1ReplicationControllerStatus()
