...
from k8sv1.models.v1_persistent_volume_claim_spec import V1PersistentVolumeClaimSpec
...
class TestV1PersistentVolumeClaimSpec(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimSpec(self):
        ...
        """
        model = k8sv1.models.v1_persistent_volume_claim_spec.V1PersistentVolumeClaimSpec()
