...
from k8sv1.models.v1_vsphere_virtual_disk_volume_source import V1VsphereVirtualDiskVolumeSource
...
class TestV1VsphereVirtualDiskVolumeSource(unittest.TestCase):
    ...
    def testV1VsphereVirtualDiskVolumeSource(self):
        ...
        """
        model = k8sv1.models.v1_vsphere_virtual_disk_volume_source.V1VsphereVirtualDiskVolumeSource()
