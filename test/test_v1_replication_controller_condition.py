...
from k8sv1.models.v1_replication_controller_condition import V1ReplicationControllerCondition
...
class TestV1ReplicationControllerCondition(unittest.TestCase):
    ...
    def testV1ReplicationControllerCondition(self):
        ...
        """
        model = k8sv1.models.v1_replication_controller_condition.V1ReplicationControllerCondition()
