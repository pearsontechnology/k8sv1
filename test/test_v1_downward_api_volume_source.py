...
from k8sv1.models.v1_downward_api_volume_source import V1DownwardAPIVolumeSource
...
class TestV1DownwardAPIVolumeSource(unittest.TestCase):
    ...
    def testV1DownwardAPIVolumeSource(self):
        ...
        """
        model = k8sv1.models.v1_downward_api_volume_source.V1DownwardAPIVolumeSource()
