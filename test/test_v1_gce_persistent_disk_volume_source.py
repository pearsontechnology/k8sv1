...
from k8sv1.models.v1_gce_persistent_disk_volume_source import V1GCEPersistentDiskVolumeSource
...
class TestV1GCEPersistentDiskVolumeSource(unittest.TestCase):
    ...
    def testV1GCEPersistentDiskVolumeSource(self):
        ...
        """
        model = k8sv1.models.v1_gce_persistent_disk_volume_source.V1GCEPersistentDiskVolumeSource()
