...
from k8sv1.models.v1_persistent_volume_claim_volume_source import V1PersistentVolumeClaimVolumeSource
...
class TestV1PersistentVolumeClaimVolumeSource(unittest.TestCase):
    ...
    def testV1PersistentVolumeClaimVolumeSource(self):
        ...
        """
        model = k8sv1.models.v1_persistent_volume_claim_volume_source.V1PersistentVolumeClaimVolumeSource()
