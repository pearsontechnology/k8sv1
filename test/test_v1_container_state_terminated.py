...
from k8sv1.models.v1_container_state_terminated import V1ContainerStateTerminated
...
class TestV1ContainerStateTerminated(unittest.TestCase):
    ...
    def testV1ContainerStateTerminated(self):
        ...
        """
        model = k8sv1.models.v1_container_state_terminated.V1ContainerStateTerminated()
